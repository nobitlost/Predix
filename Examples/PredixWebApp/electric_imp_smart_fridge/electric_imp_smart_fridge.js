...
// Predix Time Series service ingestion URL
const PREDIX_TIME_SERIES_INGEST_URL = 'wss://gateway-predix-data-services.run.aws-usw02-pr.ice.predix.io/v1/stream/messages';
...
function processIngestData(request, requestBody, response) {
    if ('predix-zone-id' in request.headers && 'authorization' in request.headers) {
        ...
        const ws = new WS(PREDIX_TIME_SERIES_INGEST_URL, { headers : wsHeaders });
